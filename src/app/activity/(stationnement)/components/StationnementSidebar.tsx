...
const menuItems: MenuEntry[] = [
  { icon: "📊", label: "Dashboard", href: "/activity/stationnement/dashboard" },

  {
    category: "Configuration",
    items: [
      { icon: "📍", label: "Zones", href: "/activity/stationnement/zones" },
    ],
  },

  {
    category: "Gestion",
    items: [
      { icon: "🚗", label: "Véhicules", href: "/activity/stationnement/vehicules" },
      { icon: "🅿️", label: "Stationnements", href: "/activity/stationnement/stationnements" },
    ],
  },

  {
    category: "Financier",
    items: [
      { icon: "💰", label: "Paiements", href: "/activity/stationnement/paiements" },
      { icon: "💸", label: "Amendes", href: "/activity/stationnement/amendes" },
    ],
  },

  {
    category: "Contrôle",
    items: [
      { icon: "🔍", label: "Contrôles", href: "/activity/stationnement/controles" },
    ],
  },
];
...
export default function StationnementSidebar({
  isSidebarOpen,
  setIsSidebarOpen,
}: SidebarProps) {
