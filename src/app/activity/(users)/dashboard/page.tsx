...
import ReproductionTable from "./components/ReproductionTable";
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    fetchInitialData();
  }, [utilisateur, refreshTrigger, filters]); // Ajouter refreshTrigger aux dépendances
  ...
  // Mettre à jour les dates par défaut (aujourd'hui)
  useEffect(() => {
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          {/* <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span className="bg-blue-50 text-blue-700 px-3 py-1 rounded-lg">
              {utilisateur.nom_complet} - {utilisateur.site_nom}
            </span>
          </div> */}
        </div>
      </header>
