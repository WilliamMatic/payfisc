...
interface DeleteParticulierModalProps {
...
export default function DeleteParticulierModal({
  particulier,
  processing,
  onClose,
  onDeleteParticulier
}: DeleteParticulierModalProps) {
  return (
      ...
      >
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800">Supprimer le contribuable</h3>
        ...
        <div className="p-5">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 mb-3">
              Êtes-vous sûr de vouloir supprimer définitivement ce contribuable ?
            </p>
            <div className="bg-red-50 border border-red-100 rounded-lg p-3 mb-3">
              ...
              <p className="text-red-700 text-xs mt-1">
                NIF: {particulier.nif} | Tél: {particulier.telephone || 'N/A'}
              </p>
            </div>
