// app/energies/components/modals/EditEnergieModal.tsx
import { X, Zap } from 'lucide-react';
import { Energie as EnergieType } from '@/services/energies/energieService';

interface EditEnergieModalProps {
  energie: EnergieType;
...
export default function EditEnergieModal({
  energie,
  formData,
  processing,
  onClose,
      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-lg font-semibold text-gray-800">Modifier l'Énergie</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex items-center justify-end space-x-3 pt-4">
            ...
            >
              {processing ? 'Modification...' : 'Modifier l\'énergie'}
            </button>
          </div>
        </form>
      </div>
