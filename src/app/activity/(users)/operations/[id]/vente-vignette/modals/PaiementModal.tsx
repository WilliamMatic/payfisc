...
import { enregistrerPaiementVignette, inscrireAssujetti } from "@/services/vente-vignette/venteVignetteService";
...
export default function PaiementModal({
  ...
  const handlePaiement = async () => {
    ...
    try {
      ...
      // Si les IDs sont 0 (données externes), inscrire d'abord dans la BDD locale
      ...
      const result = await enregistrerPaiementVignette({
        engin_id: enginId,
          ...
          <div className="px-6 py-6">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Taxe vignette automobile
              </p>
            </div>

            {/* Mode de paiement - Affiché mais non modifiable */}
            <div className="mb-6">
