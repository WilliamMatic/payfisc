...
import AssuranceMotoSearch from "./components/AssuranceMotoSearch";
...
export default async function AssuranceMotoPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-blue-50/30 py-8">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <AssuranceMotoSearch impot={impot} prix={prix} tauxCdf={tauxCdf} />
      </div>
    </div>
  );
}
