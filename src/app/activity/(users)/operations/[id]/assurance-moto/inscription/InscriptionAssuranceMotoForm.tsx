...
interface InscriptionAssuranceMotoFormProps {
  plaque: string;
  operationId: string;
}
...
export default function InscriptionAssuranceMotoForm({
  plaque,
  operationId,
}: InscriptionAssuranceMotoFormProps) {
  ...
  const validateForm = (): boolean => {
    ...
    if (!numeroAssurance.trim()) {
      setAssuranceError("Le numéro d'assurance est obligatoire");
    } else {
      setAssuranceError("");
    }
    if (formData.anneeFabrication && formData.anneeCirculation) {
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-green-800 mb-2">Assurance Validée</h3>
            <p className="text-green-700">
              L&apos;assurance pour le véhicule <strong>{plaque}</strong> a été délivrée.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-center space-x-4">
          ...
          <button
            onClick={() => router.push(`/activity/operations/${operationId}/assurance-moto`)}
              ...
              <div className="space-y-6 mb-6">
                ...
                <div className="bg-yellow-50 rounded-lg p-4 border border-yellow-200">
                  ...
                  <p className="text-yellow-700 text-sm">
                    Voulez-vous confirmer l&apos;inscription et le paiement de l&apos;assurance ?
      ...
      <form onSubmit={handleSubmitForm} className="space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-2">
                N° Assurance <span className="text-red-500">*</span>
              </label>
              <input
                type="text"
                value={numeroAssurance}
                onChange={(e) => setNumeroAssurance(e.target.value)}
                placeholder="Numéro de l'assurance"
                required
