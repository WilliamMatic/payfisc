...
import InscriptionAssuranceMotoForm from "./InscriptionAssuranceMotoForm";
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-red-50/30 flex items-center justify-center py-8">
        <div className="bg-white rounded-2xl shadow-xl border border-red-100 p-8 max-w-md w-full mx-4 text-center">
          ...
          <Link
            href={`/activity/operations/${operationId}/assurance-moto`}
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">
                Inscription & Assurance Moto
              </h1>
              <p className="text-gray-600 mt-1">
                Enregistrement d&apos;un nouveau véhicule et souscription de l&apos;assurance
              </p>
            </div>
...
export default function InscriptionAssuranceMotoClient() {
  return (
    <Suspense
      fallback={
