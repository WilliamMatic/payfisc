...
export default function InscriptionDelivranceForm({
  ...
  // ─── Confirmation finale : inscription uniquement (pas de paiement) ───
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-green-800 mb-2">Vignette Délivrée</h3>
            <p className="text-green-700">
              La vignette <strong>{numeroVignette}</strong> pour le véhicule <strong>{plaque}</strong> a été délivrée.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <span className="text-gray-500">N° Vignette :</span>
              <div className="font-bold">{numeroVignette}</div>
            </div>
            <div>
        ...
        <div className="flex justify-center space-x-4">
          ...
          <button
            onClick={() => router.push(`/activity/operations/${operationId}/delivrance-vignette?ref=${encodeURIComponent(reference)}`)}
              ...
              <div className="space-y-6 mb-6">
                <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      <span className="text-blue-600">N° Vignette :</span>
                      <div className="font-bold text-gray-900">{numeroVignette}</div>
                    </div>
                    <div>
                ...
                <div className="bg-emerald-50 rounded-lg p-4 border border-emerald-200">
                  ...
                  <p className="text-emerald-700 text-sm">
                    Cette action inscrit le véhicule, enregistre le paiement à 0$ (déjà payé via banque) et délivre la vignette.
      ...
      <div className="bg-gray-50 rounded-xl border border-gray-200 p-6 mb-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <button
              type="button"
              onClick={() => router.push(`/activity/operations/${operationId}/delivrance-vignette`)}
      ...
      <form onSubmit={handleSubmitForm} className="space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900">Paiement & Vignette</h2>
              <p className="text-gray-600 text-sm">Détails du paiement et numéro de vignette physique</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                onChange={(e) => { setNumeroVignette(e.target.value); setVignetteError(""); }}
