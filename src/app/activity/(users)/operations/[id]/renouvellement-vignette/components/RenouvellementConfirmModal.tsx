...
import { renouvelerVignette } from "@/services/vente-vignette/venteVignetteService";
...
export default function RenouvellementConfirmModal({
  ...
  const handleRenouvellement = async () => {
    ...
    try {
      const result = await renouvelerVignette({
          ...
          <div className="px-6 py-6">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-sm text-gray-500">
                La vignette sera renouvelée pour une durée de 6 mois
              </p>
            </div>
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Taxe de renouvellement vignette
              </p>
            </div>
            ...
            <div className="bg-amber-50 rounded-lg p-3 text-xs text-amber-700 flex items-start">
              ...
              <p>
                Le renouvellement prolongera la validité de la vignette pour 6
