...
import DelivranceAssuranceSearch from "./components/DelivranceAssuranceSearch";
...
export default async function DelivranceAssurancePage({ params, searchParams }: PageProps) {
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">
                Délivrance d&apos;Assurance Moto
              </h1>
              <p className="text-gray-600 mt-1">
                Vérifiez la référence bancaire puis recherchez la plaque pour délivrer le certificat d&apos;assurance
              </p>
            </div>
          </div>
        </div>

        <DelivranceAssuranceSearch impot={impot} initialRef={ref} initialPlaque={plaque} />
      </div>
    </div>
  );
}
