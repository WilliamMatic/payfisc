...
export default function AssujettiInfo({ assujetti }: AssujettiInfoProps) {
  const infos = [
    ...
    { icon: Phone, label: "Téléphone", value: assujetti.telephone || "Non renseigné" },
    ...
    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
      <div className="bg-gradient-to-r from-blue-600 to-blue-500 px-6 py-4">
        <div className="flex items-center space-x-3">
          ...
          <h2 className="text-xl font-bold text-white">Informations Assujetti</h2>
        </div>
      </div>
      <div className="p-6">
        ...
        <div className="mt-6 pt-4 border-t border-gray-100">
          <div className="bg-gray-50 rounded-lg px-4 py-2">
            ...
            <p className="text-sm font-mono font-bold text-gray-900">{assujetti.id}</p>
          </div>
        </div>
      </div>
    </div>
