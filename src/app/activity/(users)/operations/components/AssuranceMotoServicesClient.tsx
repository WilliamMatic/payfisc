...
interface AssuranceMotoServicesClientProps {
  impot: ImpotType;
}

export default function AssuranceMotoServicesClient({ impot }: AssuranceMotoServicesClientProps) {
  ...
  const services = [
    {
      ...
      title: "Souscription Assurance Moto",
      description: "Recherchez un véhicule par sa plaque minéralogique pour souscrire une assurance moto. Vérification préalable de l'immatriculation requise.",
      icon: Shield,
      color: "emerald",
      features: [
        "Recherche par plaque minéralogique",
        "Paiement sécurisé MPAKO",
        "Émission certificat d'assurance",
    ...
    {
      id: "delivrance-assurance",
      privilegeKey: "delivrance",
      title: "Délivrance Assurance",
      description: "Pour les assujettis ayant déjà payé via mobile money et qui viennent récupérer leur certificat d'assurance. Vérification du paiement et de l'immatriculation.",
      icon: Smartphone,
      color: "blue",
      features: [
    ...
    {
      id: "renouvellement-assurance",
      privilegeKey: "renouvellement",
      title: "Renouvellement Assurance",
      description: "Service de renouvellement d'assurance moto après expiration de la période de validité de 12 mois.",
      icon: RefreshCw,
      color: "amber",
      features: [
      ...
      stats: "12 mois",
      popular: true,
      requirements: ["Assurance expirée ou proche expiration", "Véhicule en règle"]
    }
  ];
  ...
  const isServiceAllowed = (privilegeKey: string): boolean => {
    ...
    return !!privileges?.assurance?.[privilegeKey];
  };
      ...
      <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-amber-700 text-sm">
                Pour le service d&apos;assurance moto, une vérification préalable de l&apos;immatriculation du véhicule est obligatoire. 
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Services Assurance Moto</h2>
        ...
        <div className="mb-6 bg-white rounded-xl border border-gray-200 p-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm font-semibold text-gray-900">Vos accès — Assurance Moto</p>
              ...
              >
                ...
                {allowed && service.popular && (
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 z-10">
                    <div className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-4 py-1.5 rounded-full text-xs font-bold flex items-center space-x-1.5 shadow-lg">
