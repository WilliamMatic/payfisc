...
interface AddEntrepriseModalProps {
  formData: {
...
export default function AddEntrepriseModal({
  formData,
  processing,
  formesJuridiques,
  onClose,
      ...
      >
        <div className="flex items-center justify-between p-5 border-b border-gray-100 sticky top-0 bg-white z-10">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800">Nouvelle Entreprise</h3>
              <p className="text-sm text-gray-500">Ajouter une nouvelle entreprise contribuable</p>
            </div>
          </div>
          <button
            onClick={onClose}
