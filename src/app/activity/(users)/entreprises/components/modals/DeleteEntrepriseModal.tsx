...
interface DeleteEntrepriseModalProps {
...
export default function DeleteEntrepriseModal({
  entreprise,
  processing,
  onClose,
  onDeleteEntreprise
}: DeleteEntrepriseModalProps) {
  return (
      ...
      >
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800">Supprimer l'entreprise</h3>
          ...
          <div className="text-center mb-6">
            ...
            <div className="bg-red-50 border border-red-100 rounded-lg p-3 mb-3">
              ...
              <p className="text-red-700 text-xs mt-1">
                NIF: {entreprise.nif} | RC: {entreprise.registre_commerce}
              </p>
            </div>
