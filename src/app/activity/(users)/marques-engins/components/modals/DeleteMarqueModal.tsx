...
interface DeleteMarqueModalProps {
...
export default function DeleteMarqueModal({
  marque,
  processing,
  onClose,
  onDeleteMarque
}: DeleteMarqueModalProps) {
  return (
      ...
      >
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800">Supprimer la marque</h3>
          ...
          <div className="text-center mb-6">
            ...
            <div className="bg-red-50 border border-red-100 rounded-lg p-3 mb-3">
              <p className="text-red-800 font-medium text-sm">
                {marque.libelle} <span className="text-red-600">({marque.type_engin_libelle})</span>
              </p>
              {marque.description && (
