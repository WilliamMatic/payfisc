...
const PaiementPage: React.FC = () => {
  ...
  // FONCTIONS D'IMPRESSION SÉPARÉES POUR RECTO ET VERSO
  ...
  // FONCTION POUR IMPRIMER LES DEUX CÔTÉS (ALTERNATIVE)
  const handlePrintComplete = (): void => {
    handlePrintRecto();
    // Délai pour permettre l'impression du recto avant de lancer le verso
    setTimeout(() => {
      // Demander à l'utilisateur de retourner la carte
      if (
        confirm(
          "Veuillez retourner la carte dans l'imprimante puis cliquez sur OK pour imprimer le verso."
        )
      ) {
        handlePrintVerso();
      }
  ...
  // MODIFIÉ: MODAL DE CARTE CR-80 AVEC IMPRESSION SÉPARÉE
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                ...
                <div className="text-yellow-700 text-sm space-y-2">
                  <p>
                    <strong>Option 1 (Recommandée):</strong> Utilisez "Imprimer
                    Recto" puis "Imprimer Verso" séparément.
                  </p>
                  <p>
                    <strong>Option 2:</strong> Utilisez "Imprimer Complet" et
                    suivez les instructions pour retourner la carte.
                  </p>
                  <p>
                    <strong>Format:</strong> Carte CR-80 (85.6mm × 53.98mm) -
            ...
            <div className="bg-gray-50 px-4 py-3 border-t border-gray-200 flex justify-center space-x-3 no-print">
              ...
              <button
                ...
                className="flex items-center bg-purple-500 text-white py-2 px-4 rounded-lg font-semibold hover:bg-purple-600 transition duration-200 text-sm"
              >
