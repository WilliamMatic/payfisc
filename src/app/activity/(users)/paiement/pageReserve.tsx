...
const PaiementPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    console.log("Formule utilisateur chargée:", utilisateur);
  ...
  // FONCTION D'IMPRESSION OPTIMISÉE POUR A4
  ...
  // MODAL DE FACTURE COMPACT POUR A4
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-4 flex justify-between items-center">
              <div>
                <h3 className="text-lg font-bold">Facture de Paiement</h3>
            ...
            <div className="flex-1 overflow-y-auto p-4">
              <div id="receipt-content">
                {/* En-tête officielle compacte */}
                <div className="header-print">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <div className="text-xs opacity-90 font-light mb-1">
                        RÉPUBLIQUE DÉMOCRATIQUE DU CONGO
                      </div>
                      <div className="institution-name">DGRK</div>
                  ...
                  <div className="invoice-title">
                    Facture Officielle de Perception
                  </div>
                </div>

                {/* Corps de la facture compact */}
                <div className="content-section">
                  <div className="grid-2">
                    {/* Informations du Contribuable */}
                    <div className="info-box print-break-inside">
                      <h3>INFORMATIONS DU CONTRIBUABLE</h3>
                      <div className="space-y-2">
                        <div className="info-item">
                          <span className="info-label">NIF:</span>
                          <span className="info-value">{nif}</span>
                        </div>
                        <div className="info-item">
                    ...
                    <div className="info-box print-break-inside">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="info-item">
                          <span className="info-label">Type d'impôt:</span>
                          <span className="info-value">{selectedTax?.nom}</span>
                        </div>
                        <div className="info-item">
                          <span className="info-label">Mode paiement:</span>
                          <span className="info-value">
                            {selectedMethod?.name}
                          </span>
                        </div>
                        <div className="info-item">
                          <span className="info-label">Déclarations:</span>
                          <span className="info-value">{declarationCount}</span>
                        </div>
                      </div>
                    </div>
                  </div>

                  {/* Section Déclarations compacte */}
                  <div className="declaration-section print-break-inside">
                    <h3>DÉTAIL DES DÉCLARATIONS</h3>

                    <div className="space-y-3">
                      {formsData.map((declarationData, index) => {
                        // 🔍 On récupère la propriété "Numéro plaque" (plusieurs variantes possibles)
                        const numeroPlaque =
                          declarationData["Numéro plaque"] ||
                          declarationData["numero_plaque"] ||
                          declarationData["Numéro_plaque"] ||
                          "-";
                        ...
                        return (
                          <div key={index} className="declaration-item">
                            ...
                            <div className="declaration-content">
                              <div className="declaration-qr">
                                <QRCodeSVG
                                  value={String(numeroPlaque)}
                                  size={60}
                                  level="M"
                                />
                              </div>
                              ...
                              <div className="declaration-data">
                                <div className="data-grid">
                                  {Object.entries(declarationData)
                                    .slice(0, 100)
                                    .map(([key, value]) => (
                  ...
                  {/* Section Total compacte */}
                  <div className="total-section print-break-inside">
                    ...
                    <div className="text-right">
                      ...
                      <div className="total-label">
                        {declarationCount} déclaration(s)
                      </div>
                    </div>
                  </div>

                  {/* Pied de page compact */}
                  <div className="footer print-break-inside">
                    <div className="text-xs mb-1">
                      Facture générée électroniquement - Valide sans signature
                    </div>
                    <div className="text-xs">
                      MPAKO © {new Date().getFullYear()} |{" "}
                      {new Date().toLocaleDateString("fr-FR")}
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-gray-50 px-4 py-3 border-t border-gray-200 flex justify-center space-x-3 no-print">
              <button
                ...
                className="flex items-center bg-blue-500 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-600 transition duration-200 text-sm"
              >
              ...
              <button
                ...
                className="flex items-center bg-green-500 text-white py-2 px-4 rounded-lg font-semibold hover:bg-green-600 transition duration-200 text-sm"
              >
