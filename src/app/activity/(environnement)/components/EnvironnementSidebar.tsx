...
const menuItems: MenuEntry[] = [
  { icon: "📊", label: "Dashboard", href: "/activity/environnement/dashboard" },

  {
    category: "Configuration",
    items: [
      { icon: "🏘️", label: "Communes", href: "/activity/environnement/communes" },
      { icon: "📍", label: "Quartiers", href: "/activity/environnement/quartiers" },
      { icon: "🛣️", label: "Avenues", href: "/activity/environnement/avenues" },
      { icon: "🏭", label: "Types d'activité", href: "/activity/environnement/types-activite" },
      { icon: "☁️", label: "Types de pollution", href: "/activity/environnement/types-pollution" },
      { icon: "⚡", label: "Niveaux de risque", href: "/activity/environnement/niveaux-risque" },
      { icon: "📋", label: "Catégories de taxe", href: "/activity/environnement/categories-taxe" },
    ],
  },

  {
    category: "Gestion",
    items: [
      { icon: "👤", label: "Contribuables", href: "/activity/environnement/contribuables" },
      { icon: "🔬", label: "Évaluations", href: "/activity/environnement/evaluations" },
      { icon: "📄", label: "Factures", href: "/activity/environnement/factures" },
    ],
  },

  {
    category: "Financier",
    items: [
      { icon: "💰", label: "Paiements", href: "/activity/environnement/paiements" },
      { icon: "💸", label: "Répartitions", href: "/activity/environnement/repartitions" },
    ],
  },

  {
    category: "Contrôle",
    items: [
      { icon: "🔍", label: "Contrôles", href: "/activity/environnement/controles" },
      { icon: "⚠️", label: "Sanctions", href: "/activity/environnement/sanctions" },
    ],
  },
];
...
export default function EnvironnementSidebar({
  isSidebarOpen,
  setIsSidebarOpen,
}: SidebarProps) {
