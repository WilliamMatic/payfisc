...
export default function Login() {
  ...
  const handleLogin = async (credentials: LoginCredentials) => {
    ...
    try {
      const result = await login(credentials.identifiant, credentials.password);
      
      if (result.success) {
        console.log('Connexion réussie - Type:', result.userType);
        ...
        <div className={styles.content}>
          <div className={styles.card}>
            <div className={styles.header}>
              ...
              <p className={styles.subtitle}>Plateforme de gestion fiscale</p>
            </div>
