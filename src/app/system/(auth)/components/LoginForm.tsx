    ...
    <form onSubmit={handleSubmit} className={styles.form}>
      <div className={styles.inputGroup}>
        ...
        <input 
          ...
          placeholder="votre@email.com ou +243XXXXXXXXX" 
          disabled={isLoading}
        />
      </div>
      ...
      <div className={styles.loginInfo}>
        <p className={styles.infoText}>
          <strong>Agents:</strong> Utilisez votre email professionnel<br/>
          <strong>Utilisateurs:</strong> Utilisez votre numéro de téléphone
        </p>
      </div>
    </form>
  );
