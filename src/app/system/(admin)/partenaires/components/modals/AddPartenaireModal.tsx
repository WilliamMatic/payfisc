...
interface AddPartenaireModalProps {
...
export default function AddPartenaireModal({
  formData,
  processing,
  onClose,
  onFormDataChange,
  onAddPartenaire,
}: AddPartenaireModalProps) {
  return (
      ...
      >
        <div className="flex items-center justify-between p-5 border-b border-gray-100 sticky top-0 bg-white z-10">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800">Nouveau Partenaire</h3>
              <p className="text-sm text-gray-500">Ajouter un partenaire de paiement</p>
            </div>
          </div>
        ...
        <div className="p-5 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => onFormDataChange({ ...formData, site_web: e.target.value })}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D5B7A]/30 focus:border-[#2D5B7A]"
                  placeholder="https://..."
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => onFormDataChange({ ...formData, contact_principal: e.target.value })}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D5B7A]/30 focus:border-[#2D5B7A]"
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="number"
                  value={formData.limite_transaction_journaliere}
                  onChange={(e) => onFormDataChange({ ...formData, limite_transaction_journaliere: e.target.value })}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D5B7A]/30 focus:border-[#2D5B7A]"
                />
              </div>
              <div>
                ...
                <input
                  type="number"
                  value={formData.limite_transaction_mensuelle}
                  onChange={(e) => onFormDataChange({ ...formData, limite_transaction_mensuelle: e.target.value })}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D5B7A]/30 focus:border-[#2D5B7A]"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => onFormDataChange({ ...formData, montant_minimum: e.target.value })}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D5B7A]/30 focus:border-[#2D5B7A]"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => onFormDataChange({ ...formData, montant_maximum: e.target.value })}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D5B7A]/30 focus:border-[#2D5B7A]"
                />
              </div>
              <div>
                ...
                <input
                  type="text"
                  value={formData.url_webhook_confirmation}
                  onChange={(e) => onFormDataChange({ ...formData, url_webhook_confirmation: e.target.value })}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D5B7A]/30 focus:border-[#2D5B7A]"
                  placeholder="https://..."
                />
              </div>
              <div>
                ...
                <input
                  type="text"
                  value={formData.url_webhook_annulation}
                  onChange={(e) => onFormDataChange({ ...formData, url_webhook_annulation: e.target.value })}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D5B7A]/30 focus:border-[#2D5B7A]"
                  placeholder="https://..."
                />
              </div>
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  onChange={(e) => onFormDataChange({ ...formData, date_expiration: e.target.value })}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D5B7A]/30 focus:border-[#2D5B7A]"
                />
              </div>
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="sm:col-span-2">
                ...
                <input
                  type="text"
                  value={formData.base_url_api}
                  onChange={(e) => onFormDataChange({ ...formData, base_url_api: e.target.value })}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D5B7A]/30 focus:border-[#2D5B7A]"
              ...
              <div>
                ...
                <input
                  type="number"
                  value={formData.timeout_api}
                  onChange={(e) => onFormDataChange({ ...formData, timeout_api: e.target.value })}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D5B7A]/30 focus:border-[#2D5B7A]"
                  min="1"
                  max="120"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => onFormDataChange({ ...formData, retry_attempts: e.target.value })}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D5B7A]/30 focus:border-[#2D5B7A]"
                  min="0"
                  max="10"
                />
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  onChange={(e) => onFormDataChange({ ...formData, ip_whitelist: e.target.value })}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D5B7A]/30 focus:border-[#2D5B7A]"
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  onChange={(e) => onFormDataChange({ ...formData, ip_autorisees: e.target.value })}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D5B7A]/30 focus:border-[#2D5B7A]"
                  placeholder="Une IP par ligne&#10;192.168.1.1&#10;10.0.0.1"
                  rows={3}
                />
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  value={formData.user_agent_autorises}
                  onChange={(e) => onFormDataChange({ ...formData, user_agent_autorises: e.target.value })}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D5B7A]/30 focus:border-[#2D5B7A]"
                  placeholder="Un user agent par ligne&#10;MyApp/1.0&#10;PartnerSDK/2.3"
                  rows={3}
                />
              </div>
            </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
            <p className="text-blue-800 text-xs">
              <strong>Note :</strong> Le <code>bank_id</code> et la <code>api_key</code> seront générés automatiquement lors de la création.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-end space-x-3 p-5 border-t border-gray-100 sticky bottom-0 bg-white">
          ...
          >
            ...
            <span>{processing ? 'Création...' : 'Créer le partenaire'}</span>
          </button>
        </div>
      </div>
    </div>
