      ...
      >
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800">Supprimer la série</h3>
        ...
        <div className="p-5">
          <div className="text-center mb-6">
            ...
            <div className="bg-red-50 border border-red-100 rounded-lg p-3 mb-3">
              ...
              <p className="text-red-700 text-sm mt-1">
                {serie.items_disponibles}/{serie.total_items} plaques disponibles
              </p>
              {serie.description && (
            ...
            {serie.items_utilises > 0 && (
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-3 mb-3">
                <p className="text-orange-800 text-sm font-medium">
                  ⚠️ Attention : {serie.items_utilises} plaque(s) sont utilisées
                </p>
                <p className="text-orange-700 text-xs mt-1">
                  La suppression n'est pas possible tant que des plaques sont utilisées
                </p>
              </div>
            )}
          ...
          <div className="flex items-center justify-center space-x-3 pt-4 border-t border-gray-100">
            ...
            <button
              ...
              disabled={processing || serie.items_utilises > 0}
