...
import { FileText, DollarSign, Users, Car, Loader2 } from "lucide-react";
import { getStatsCommandes } from "@/services/commande/commandesService";
import type { StatsCommandes as StatsType, FilterState } from "../types";
...
interface StatsCommandesProps {
  searchTerm: string;
  filters: FilterState;
  onError: (error: string | null) => void;
}

export interface StatsCommandesRef {
  refresh: () => Promise<void>;
}

const StatsCommandes = forwardRef<StatsCommandesRef, StatsCommandesProps>(
  ({ searchTerm, filters, onError }, ref) => {
...
StatsCommandes.displayName = "StatsCommandes";

export default StatsCommandes;
