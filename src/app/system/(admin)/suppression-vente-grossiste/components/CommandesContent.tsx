...
import { getSitesDisponibles } from "@/services/commande/commandesService";
import StatsCommandes from "./StatsCommandes";
...
export default function CommandesContent() {
  ...
  const commandesTableRef = useRef<{ refresh: () => Promise<void> }>(null);
  ...
  const refreshAllData = useCallback(async () => {
    ...
    // Rafraîchir la table
    if (commandesTableRef.current) {
      await commandesTableRef.current.refresh();
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-6">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Table des commandes avec Suspense */}
        <CommandesTable
          ref={commandesTableRef}
          searchTerm={searchTerm}
          filters={filters}
          sites={sites}
