...
export const metadata: Metadata = {
  title: "Commandes de Plaques - PayFisc",
  description: "Gestion des commandes de plaques aux clients simples",
};

// Composant de chargement pour le contenu principal
function CommandesLoading() {
  return (
...
export default function CommandesPlaquesPage() {
  return (
    <Suspense fallback={<CommandesLoading />}>
      <CommandesContent />
    </Suspense>
  );
}