...
interface StatsCartesRosesProps {
  searchTerm: string;
  filters: FilterState;
...
export interface StatsCartesRosesRef {
  refresh: () => Promise<void>;
}

const StatsCartesRoses = forwardRef<StatsCartesRosesRef, StatsCartesRosesProps>(
  ({ searchTerm, filters, onError, formatDate }, ref) => {
...
StatsCartesRoses.displayName = "StatsCartesRoses";

export default StatsCartesRoses;
