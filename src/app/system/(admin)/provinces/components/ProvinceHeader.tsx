...
export default function ProvinceHeader({ searchTerm, onSearchChange, onAddClick }: ProvinceHeaderProps) {
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
      <div className="flex items-center">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-800">Provinces</h2>
          <p className="text-sm text-gray-500">Gérez les provinces de votre application</p>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
        ...
        >
          ...
          <span className="font-medium text-sm">Nouvelle Province</span>
        </button>
      </div>
    </div>
  );
