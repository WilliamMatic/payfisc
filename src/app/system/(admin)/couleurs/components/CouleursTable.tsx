                ...
                <tr key={couleur.id} className="hover:bg-gray-50/80 transition-colors">
                  ...
                  <td className="px-5 py-4 whitespace-nowrap">
                    <div className="flex items-center justify-center space-x-1">
                      <button
                        onClick={() => onToggleStatus(couleur)}
                        className={`p-2 rounded-lg transition-colors ${
                          couleur.actif 
                            ? 'text-red-600 hover:bg-red-50' 
                            : 'text-green-600 hover:bg-green-50'
                        }`}
                        title={couleur.actif ? 'Désactiver' : 'Activer'}
                      >
                        {couleur.actif ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                      </button>
                      <button
                        onClick={() => onEdit(couleur)}
