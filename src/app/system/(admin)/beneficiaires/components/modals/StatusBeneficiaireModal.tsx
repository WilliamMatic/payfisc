...
interface StatusBeneficiaireModalProps {
...
export default function StatusBeneficiaireModal({
  beneficiaire,
  processing,
  onClose,
  onToggleStatus,
}: StatusBeneficiaireModalProps) {
  return (
          ...
          <div className="flex items-center">
            <div
              className={`p-2 rounded-lg mr-3 ${
                beneficiaire.actif ? "bg-red-100" : "bg-green-100"
              }`}
            >
              {beneficiaire.actif ? (
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800">
                {beneficiaire.actif ? "Désactiver" : "Activer"} le bénéficiaire
              </h3>
          ...
          <div className="text-center mb-6">
            <div
              className={`w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4 ${
                beneficiaire.actif ? "bg-red-50" : "bg-green-50"
              }`}
            >
              {beneficiaire.actif ? (
            ...
            <p className="text-gray-600 mb-2">
              ...
              {beneficiaire.actif ? "désactiver" : "activer"} ce bénéficiaire ?
            </p>
            <p className="text-gray-800 font-medium">
              {beneficiaire.nom}{" "}
              <span className="text-gray-400">({beneficiaire.id})</span>
            </p>
            <p className="text-gray-600 text-sm mt-1">
              {beneficiaire.telephone} - {beneficiaire.numero_compte}
            </p>
          </div>
