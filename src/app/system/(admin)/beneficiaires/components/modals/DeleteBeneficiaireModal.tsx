...
interface DeleteBeneficiaireModalProps {
      ...
      >
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800">Supprimer le bénéficiaire</h3>
        ...
        <div className="p-5">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 mb-3">
              Êtes-vous sûr de vouloir supprimer définitivement ce bénéficiaire ?
            </p>
            <div className="bg-red-50 border border-red-100 rounded-lg p-3 mb-3">
              <p className="text-red-800 font-medium text-sm">
                {beneficiaire.nom} <span className="text-red-600">({beneficiaire.id})</span>
              </p>
