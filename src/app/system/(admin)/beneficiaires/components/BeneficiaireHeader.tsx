...
export default function BeneficiaireHeader({
  searchTerm,
  onSearchChange,
  onAddClick,
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
      ...
      <div className="flex items-center">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-800">Bénéficiaires</h2>
          <p className="text-sm text-gray-500">
            Gérez les bénéficiaires de votre application
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
        ...
        >
          ...
          <span className="font-medium text-sm">Nouveau Bénéficiaire</span>
        </button>
      </div>
    </div>
  );
