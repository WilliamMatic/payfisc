...
export const metadata: Metadata = {
  title: "Suppression Ventes Simple - PayFisc",
  description: "Gestion des ventes aux particuliers",
};

// Composant de chargement pour le contenu principal
function VentesLoading() {
  return (
...
export default function VentesNonGrossistesPage() {
  return (
    <Suspense fallback={<VentesLoading />}>
      <VentesContent />
    </Suspense>
  );
}