        ...
        <div className="p-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => onFormDataChange({...formData, date_naissance: e.target.value})}
                className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#153258]/30 focus:border-[#153258] transition-colors"
                disabled={processing}
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => onFormDataChange({...formData, lieu_naissance: e.target.value})}
                className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#153258]/30 focus:border-[#153258] transition-colors"
            ...
            <div>
              ...
              <select
                value={formData.sexe}
                onChange={(e) => onFormDataChange({...formData, sexe: e.target.value})}
                className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#153258]/30 focus:border-[#153258] transition-colors"
                disabled={processing}
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => onFormDataChange({...formData, id_national: e.target.value})}
                className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#153258]/30 focus:border-[#153258] transition-colors"
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => onFormDataChange({...formData, situation_familiale: e.target.value})}
                className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#153258]/30 focus:border-[#153258] transition-colors"
                disabled={processing}
              >
                <option value="">Sélectionner</option>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => onFormDataChange({...formData, dependants: parseInt(e.target.value) || 0})}
                className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#153258]/30 focus:border-[#153258] transition-colors"
                min="0"
                disabled={processing}
              />
            ...
            <div className="md:col-span-2">
              ...
              <input
                type="text"
                value={formData.rue}
                onChange={(e) => onFormDataChange({...formData, rue: e.target.value})}
                className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#153258]/30 focus:border-[#153258] transition-colors"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => onFormDataChange({...formData, code_postal: e.target.value})}
                className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#153258]/30 focus:border-[#153258] transition-colors"
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => onFormDataChange({...formData, province: e.target.value})}
                className="w-full px-3 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#153258]/30 focus:border-[#153258] transition-colors"
                disabled={processing}
              >
          ...
          <div className="flex items-center justify-end space-x-3 mt-6 pt-4 border-t border-gray-100">
            ...
            <button
              ...
              disabled={!formData.nom.trim() || !formData.prenom.trim() || !formData.nif.trim() || !formData.date_naissance || processing}
