...
interface EntreprisesHeaderProps {
  searchTerm: string;
...
export default function EntreprisesHeader({ searchTerm, onSearchChange, onSearch, onAddClick }: EntreprisesHeaderProps) {
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
      <div className="flex items-center">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-800">Contribuables Entreprises</h2>
          <p className="text-sm text-gray-500">Gérez les entreprises contribuables</p>
        </div>
      </div>
