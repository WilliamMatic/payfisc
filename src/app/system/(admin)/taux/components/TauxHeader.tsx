import { Percent, Search, Plus } from 'lucide-react';

interface TauxHeaderProps {
  searchTerm: string;
  onSearchChange: (value: string) => void;
  onAddClick: () => void;
}

export default function TauxHeader({ searchTerm, onSearchChange, onAddClick }: TauxHeaderProps) {
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
      <div className="flex items-center">
        <div className="bg-gradient-to-r from-[#153258] to-[#23A974] p-2.5 rounded-lg mr-3">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
        ...
        >
          ...
          <span className="font-medium text-sm">Nouveau Taux</span>
        </button>
      </div>
    </div>
  );
