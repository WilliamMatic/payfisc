        ...
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          <div className="flex items-center">
            <div className={`p-2 rounded-lg mr-3 ${
              taux.actif ? 'bg-red-100' : 'bg-green-100'
            }`}>
              {taux.actif ? (
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800">
                {taux.actif ? 'Désactiver' : 'Activer'} le taux
              </h3>
        ...
        <div className="p-5">
          <div className="text-center mb-6">
            <div className={`w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4 ${
              taux.actif ? 'bg-red-50' : 'bg-green-50'
            }`}>
              {taux.actif ? (
            ...
            <p className="text-gray-600 mb-2">
              Êtes-vous sûr de vouloir {taux.actif ? 'désactiver' : 'activer'} ce taux ?
            </p>
            <p className="text-gray-800 font-medium">
              {taux.nom} - {taux.valeur ? taux.valeur.toLocaleString('fr-FR') : '0'} CDF
            </p>
          </div>
          ...
          <div className="flex items-center justify-center space-x-3 pt-4 border-t border-gray-100">
            ...
            >
              ...
              <span>{processing ? 'Traitement...' : taux.actif ? 'Désactiver' : 'Activer'}</span>
            </button>
          </div>
        </div>
      </div>
