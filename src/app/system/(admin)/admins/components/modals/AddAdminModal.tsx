...
import { Province as ProvinceType } from '@/services/admins/adminService';
      ...
      >
        ...
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800">Nouvel Administrateur</h3>
              <p className="text-sm text-gray-500">Ajouter un nouvel administrateur</p>
            </div>
          </div>
          <button
            onClick={onClose}
            ...
            {formData.role === 'partenaire' && (
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  L'administrateur partenaire aura accès uniquement aux données de cette province
                </p>
              </div>
            )}

            {/* MESSAGE INFO MOT DE PASSE */}
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              <p className="text-blue-800 text-sm">
                <strong>Information :</strong> Un mot de passe à 4 chiffres sera généré automatiquement et affiché après la création.
              </p>
            </div>
          </div>
