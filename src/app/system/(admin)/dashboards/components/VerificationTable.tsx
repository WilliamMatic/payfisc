import { Search, Loader2, ChevronRight, Printer } from "lucide-react";
...
interface VerificationTableProps {
  ...
  onGenerateRapport: (declarationId: number) => void; // Nouvelle prop
}
              ...
              {taxData.map((tax, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">
                      ...
                      <div className="text-xs text-gray-500 capitalize">
                        {tax.type_contribuable}
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-semibold text-gray-900">
                      {tax.montant_du.toLocaleString()} $
                    </div>
                    <div className="text-xs text-green-600">
                      Payé: {tax.montant_paye.toLocaleString()} $
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <button
                      onClick={() => onGenerateRapport(tax.declaration_id)}
