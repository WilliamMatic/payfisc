...
interface DeleteImpotModalProps {
  impot: ImpotType;
  processing: boolean;
  onClose: () => void;
...
export default function DeleteImpotModal({
  impot,
  processing,
  onClose,
  onDeleteImpot
}: DeleteImpotModalProps) {
  return (
      ...
      >
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800">Supprimer l'impôt</h3>
        ...
        <div className="p-5">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 mb-3">
              Êtes-vous sûr de vouloir supprimer définitivement cet impôt ?
            </p>
