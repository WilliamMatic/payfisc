...
interface StatusImpotModalProps {
  impot: ImpotType;
  processing: boolean;
  onClose: () => void;
...
export default function StatusImpotModal({
  impot,
  processing,
  onClose,
  onToggleStatus
}: StatusImpotModalProps) {
  return (
        ...
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          <div className="flex items-center">
            <div className={`p-2 rounded-lg mr-3 ${
              impot.actif ? 'bg-red-100' : 'bg-green-100'
            }`}>
              {impot.actif ? (
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800">
                {impot.actif ? 'Désactiver' : 'Activer'} l'impôt
              </h3>
        ...
        <div className="p-5">
          <div className="text-center mb-6">
            <div className={`w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4 ${
              impot.actif ? 'bg-red-50' : 'bg-green-50'
            }`}>
              {impot.actif ? (
            ...
            <p className="text-gray-600 mb-2">
              Êtes-vous sûr de vouloir {impot.actif ? 'désactiver' : 'activer'} cet impôt ?
            </p>
          ...
          <div className="flex items-center justify-center space-x-3 pt-4 border-t border-gray-100">
            ...
            >
              ...
              <span>{processing ? 'Traitement...' : impot.actif ? 'Désactiver' : 'Activer'}</span>
            </button>
          </div>
        </div>
      </div>
