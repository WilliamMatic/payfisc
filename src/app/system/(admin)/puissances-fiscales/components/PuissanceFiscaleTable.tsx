                ...
                <tr key={puissance.id} className="hover:bg-gray-50/80 transition-colors">
                  ...
                  <td className="px-5 py-4 whitespace-nowrap">
                    <div className="flex items-center justify-center space-x-1">
                      <button
                        onClick={() => onToggleStatus(puissance)}
                        className={`p-2 rounded-lg transition-colors ${
                          puissance.actif 
                            ? 'text-gray-500 hover:bg-gray-100' 
                            : 'text-green-600 hover:bg-green-50'
                        }`}
                        title={puissance.actif ? 'Désactiver' : 'Activer'}
                      >
                        {puissance.actif ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                      </button>
                      <button
                        onClick={() => onEdit(puissance)}
