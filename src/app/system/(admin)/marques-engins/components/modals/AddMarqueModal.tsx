...
export default function AddMarqueModal({
  formData,
  typeEngins,
  processing,
  onClose,
      ...
      >
        ...
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800">Nouvelle Marque</h3>
              <p className="text-sm text-gray-500">Ajouter une nouvelle marque d'engin</p>
            </div>
          </div>
          <button
            onClick={onClose}
