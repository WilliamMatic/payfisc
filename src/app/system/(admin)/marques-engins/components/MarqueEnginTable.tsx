      ...
      <div className="overflow-x-auto h-full">
        <table className="w-full">
          ...
          <tbody className="bg-white divide-y divide-gray-100">
            {marques.map((marque) => (
              marque && (
                <tr key={marque.id} className="hover:bg-gray-50/80 transition-colors">
                  <td className="px-5 py-4 whitespace-nowrap">
                    <div className="font-medium text-gray-900 text-sm">{marque.libelle || 'N/A'}</div>
                  </td>
                  <td className="px-5 py-4 whitespace-nowrap">
                  ...
                  <td className="px-5 py-4 text-gray-600 text-sm max-w-xs truncate" title={marque.description}>
                  ...
                  <td className="px-5 py-4 whitespace-nowrap">
                    <div className="flex items-center justify-center space-x-1">
                      <button
                        ...
                        title={marque.actif ? 'Désactiver' : 'Activer'}
                      >
                        {marque.actif ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                      </button>
                      <button
        ...
        {marques.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-400 text-sm mt-1">Les marques apparaîtront ici une fois ajoutées</p>
          </div>
        )}
      </div>
    </div>
