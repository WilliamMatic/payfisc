<?php
/**
 * Script de création d'une nouvelle entreprise
 */
...
$data = [
    ...
    'utilisateur_id' => isset($_POST['utilisateur_id']) ? intval($_POST['utilisateur_id']) : null,
    'site_code' => isset($_POST['site_code']) ? trim(htmlspecialchars($_POST['site_code'], ENT_QUOTES, 'UTF-8')) : null
];
...
try {
    ...
    // Tentative d'ajout de la nouvelle entreprise
    $result = $entrepriseManager->ajouterEntreprise($data);
