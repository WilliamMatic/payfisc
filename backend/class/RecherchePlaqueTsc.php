...
require_once 'Connexion_tsc.php';

/**
 * Classe RecherchePlaque - Gestion de la recherche de plaques
 */
class RecherchePlaque extends Connexion_tsc
{
    ...
    //         // Requête principale avec tous les LEFT JOIN
    //         $sql = "SELECT 
    //             -- Informations client
    ...
    //             -- Marque
    //             CONCAT(
    //                 finance_marquev.libelle,
    //                 ' ',
    //                 COALESCE(finance_modelev.libelle, '')
    //             ) AS marque,
    ...
    //             // Requête principale avec tous les LEFT JOIN
    //             $sql = "SELECT noms AS nom_complet, adresse, '' AS telephone, 
    //                     chassis, moteur, anneefabr AS annee_fabrication, anneecir AS annee_circulation,
    //                     marquemodele AS marque, '' AS modele, 'Essence' AS energie,
    //                     couleur, usages AS usage_vehicule, 'Bicycle — Tricycle' AS type_auto,
    //                     puisfiscale AS puissance, plaque AS numero_plaque,
    //                     '32' AS montant_suivi, DATE(datecreation) AS date_achat_plaque
    //                     FROM finance_gplaqueonline WHERE plaque = :plaque";
