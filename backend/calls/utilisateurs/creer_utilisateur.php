...
if (!isset($_POST['nom_complet'], $_POST['telephone'], $_POST['site_affecte_id'])) {
    echo json_encode(["status" => "error", "message" => "Le nom complet, le téléphone et le site sont obligatoires."]);
    exit;
}
...
try {
    ...
    // Tentative d'ajout du nouvel utilisateur
    $result = $utilisateurManager->ajouterUtilisateur($nomComplet, $telephone, $adresse, $siteAffecteId, $privileges);
