<?php
/**
 * Script de suppression d'une puissance fiscale
 */
...
if (!isset($_POST['id'])) {
    echo json_encode(["status" => "error", "message" => "L'ID de la puissance fiscale est requis."]);
    exit;
}
...
try {
    ...
    // Tentative de suppression de la puissance fiscale
    $result = $puissanceManager->supprimerPuissanceFiscale($id);
