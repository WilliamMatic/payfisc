<?php
// backend/calls/assurance-moto/verifier_reference.php
...
try {
    ...
    $result = $assuranceMoto->verifierReferenceBancaire($reference, $impotId);
    ...
    error_log("Erreur vérification référence assurance: " . $e->getMessage());
