<?php
/**
 * Script de changement de statut d'un site
 */
...
if (!isset($_POST['id'], $_POST['actif'])) {
    echo json_encode(["status" => "error", "message" => "L'ID du site et le statut sont requis."]);
    exit;
}
...
try {
    ...
    $result = $siteManager->changerStatutSite($id, $actif);
