<?php
/**
 * Script de suppression d'une entreprise
 */
...
try {
    ...
    // Tentative de suppression de l'entreprise
    $result = $entrepriseManager->supprimerEntreprise($id);
    echo json_encode($result);

} catch (Exception $e) {
    // Journalisation de l'erreur pour le débogage
    error_log("Erreur lors de la suppression d'une entreprise : " . $e->getMessage());
