<?php
/**
 * Script de changement de statut d'une série
 */
...
if (!isset($_POST['id'], $_POST['actif'])) {
    echo json_encode(["status" => "error", "message" => "L'ID de la série et le statut sont requis."]);
    exit;
}
...
try {
    ...
    $result = $plaqueManager->changerStatutSerie($id, $actif);
