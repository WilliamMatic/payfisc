<?php
/**
 * Script de changement de statut d'une marque d'engin
 */
...
if (!isset($_POST['id'], $_POST['actif'])) {
    ...
    echo json_encode(["status" => "error", "message" => "L'ID de la marque et le statut sont requis."]);
    exit;
}
...
try {
    ...
    $result = $marqueManager->changerStatutMarque($id, $actif);
